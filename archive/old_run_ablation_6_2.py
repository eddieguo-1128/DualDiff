...
gammas = ["scheduler to 0.2"] # default is "scheduler to 0.2"
...
for classification_loss in classification_losses:
    for alpha in alphas:
        for beta in betas:
              for gamma in gammas:
                ...
                for seed in seeds: 
                            ...
                            # Construct run name
                            run_name = f"lossablation_{classification_loss}_a{alpha}_b{beta}_g{gamma}_s{seed}_z{z_norm_mode}"
